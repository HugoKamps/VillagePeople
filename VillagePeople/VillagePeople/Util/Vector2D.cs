...
namespace VillagePeople.Util {
    public class Vector2D {
        ...
        public static Vector2D Scale(Vector2D v1, double target) => new Vector2D(v1.X, v1.Y, v1.W).Scale(target);
        ...
        public static Vector2D Vec2DRotateAroundOrigin(Vector2D v, float angle) => new Matrix().Rotate(angle).TransformToVector2D(v);
